...
.flip-card-back {
  ...
  transform: rotateY(180deg);
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        <h2 class="text-2xl font-bold  text-center text-white font-mono">CURRENT SEASON F1 DRIVERS</h2>
        ...
        <div class="flip-card-front rounded-2xl overflow-hidden">
            ...
            <div class="p-4 text-white h-[100px] flex flex-col justify-between rounded-b-2xl">
                <div class="flex items-center justify-between mb-1">
                    <h5 class="text-base font-semibold leading-tight">
                ...
                <p class="text-sm"><strong>Team:</strong> {{ $constructorName }}</p>
            </div>
        </div>
...
<div class="flip-card-back rounded-2xl flex flex-col justify-center items-center p-6"
    ...
    <h3 class="text-xl font-semibold mb-4">Season Stats</h3>
